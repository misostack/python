...
aDict = { "firstName": "Son", "lastName": "Nguyen", "middleName": "Minh" }
print("Type of {} is {}".format(aDict, type(aDict)))

aSet = {1, 2, 3, "four", "five"}
print("Type of {} is {}".format(aSet, type(aSet)))
...
print("Is {} is truthy? {}".format(anEmptyDict, bool(anEmptyDict)))
